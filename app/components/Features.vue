...
<section id="features" class="py-16 md:py-24 bg-white/80 font-sans">
  <div class="max-w-3xl mx-auto px-4">
    ...
    <div class="mb-12 text-center">
      ...
      >
        <span class="text-pink-500">3 actions</span> pour transformer ton live<br class="hidden md:inline" />
    ...
    <div class="space-y-6">
      <!-- Feature 1 -->
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden transition border border-gray-100">
        <button
          @click="activeIndex = activeIndex === 0 ? null : 0"
          class="w-full flex justify-between items-center px-6 py-5 focus:outline-none"
        >
          <span class="flex items-center gap-2 text-lg md:text-xl font-bold text-gray-900">
        ...
        <transition name="fade">
          <div v-if="activeIndex === 0" class="px-6 pb-6">
            <p class="text-gray-700 text-base md:text-lg font-medium mb-4">
              ...
              <span class="text-pink-500">SpyLive reconnaît produit & taille,</span>
      ...
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden transition border border-gray-100">
        ...
        <transition name="fade">
          <div v-if="activeIndex === 1" class="px-6 pb-6">
            <p class="text-gray-700 text-base md:text-lg font-medium mb-4">
              Pas trouvé le message ? <span class="text-blue-500">Le client ouvre ton lien bio,</span>
        ...
        <transition name="fade">
          <div v-if="activeIndex === 2" class="px-6 pb-6">
            <p class="text-gray-700 text-base md:text-lg font-medium mb-4">
              ...
              <span class="text-gray-500">Tu regardes ton CA grimper, sans lever le doigt.</span>
            </p>
            <img
